...
import { YonetimToolbarState } from "../_state/yonetim-toolbar.state";


export class YonetimToolbarFactory {

  static grid(ctx: YonetimToolbarState): TableToolbar {
    return {
      left: [
        {
          type: 'button',
  ...
  // static tabA(ctx: YonetimToolbarState): TableToolbar {
  //   return {
  //     left: [
  //       {
  //         type: 'button',
