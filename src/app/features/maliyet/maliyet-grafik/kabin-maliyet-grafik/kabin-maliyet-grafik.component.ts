...
@Component({
  selector: 'app-kabin-maliyet-grafik',
  standalone: false,
  templateUrl: './kabin-maliyet-grafik.component.html',
  styleUrl: './kabin-maliyet-grafik.component.scss',
})
export class KabinMaliyetGrafikComponent  implements OnInit {
